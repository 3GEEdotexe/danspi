 ...
 */
RTC_DATA_ATTR static volatile RadioOperatingModes_t OperatingMode;

/*!
 * \brief Stores the current packet type set in the radio
 */
RTC_DATA_ATTR static RadioPacketTypes_t PacketType;
 ...
 */
RTC_DATA_ATTR static bool ImageCalibrated = false;
